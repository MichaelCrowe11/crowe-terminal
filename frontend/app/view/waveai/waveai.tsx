    ...
    return (
        <div className="flex h-full w-full flex-col px-6 text-center">
            ...
            <div className="mx-auto flex w-full max-w-[760px] flex-col items-center">
                <h2 className="text-xl font-semibold text-primary">This legacy Crowe Logic block is no longer supported</h2>
                <p className="mt-3 text-sm leading-6 text-secondary">
                    This older AI widget has been retired. Please use the modern Crowe Logic panel for AI chats, terminal
                    context, tools, and uploads going forward.
                </p>
                <Button className="mt-6 cursor-pointer" onClick={handleOpenAIPanel}>
                    Open Crowe Logic panel
                </Button>
            </div>
