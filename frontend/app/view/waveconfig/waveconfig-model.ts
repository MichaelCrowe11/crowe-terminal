    ...
    return [
        {
            ...
            path: "settings.json",
            language: "json",
            docsUrl: "https://docs.crowelogic.com/terminal/config",
            hasJsonView: true,
        },
        {
            name: "Connections",
            ...
            language: "json",
            docsUrl: "https://docs.crowelogic.com/terminal/connections",
        ...
        },
        {
            ...
            path: "widgets.json",
            language: "json",
            docsUrl: "https://docs.crowelogic.com/terminal/customwidgets",
            hasJsonView: true,
        },
        {
            ...
            language: "json",
            docsUrl: "https://docs.crowelogic.com/terminal/tab-backgrounds",
            hasJsonView: true,
        },
        {
            name: "Secrets",
...
const deprecatedConfigFiles: ConfigFile[] = [
    ...
    },
    {
        ...
        language: "json",
        deprecated: true,
        docsUrl: "https://docs.crowelogic.com/terminal/ai-presets",
