...
import hypheusMark from "/logos/hypheus-mark.png";
...
export const ViewLogoCommand = ({ onComplete }: { onComplete?: () => void }) => {
    return (
        <FakeCommand command="wsh view public/logos/hypheus-mark.png" onComplete={onComplete}>
            <FakeBlock icon="image" name="hypheus-mark.png" imgsrc={hypheusMark} />
        </FakeCommand>
    );
};
