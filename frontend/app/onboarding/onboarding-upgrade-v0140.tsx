    ...
    return (
        <div className="flex flex-col items-start w-full mb-2 unselectable">
            <div className="text-secondary leading-relaxed mb-4">
                <p className="mb-0">
                    Crowe Terminal v0.14 introduces Durable Sessions. Enable them to keep your remote sessions alive through
            ...
            <div className="flex w-full items-start gap-4 mb-4">
                ...
                <div className="flex flex-col items-start gap-2 flex-1">
                    <div className="text-foreground text-base font-semibold leading-[18px]">
                        ...
                        <button
                            onClick={() =>
                                waveEnv.electron.openExternal("https://docs.crowelogic.com/terminal/durable-sessions")
                            }
