...
function LearnMoreButton() {
    ...
    return (
        <button
            ...
            onClick={() => waveEnv.electron.openExternal("https://docs.crowelogic.com/terminal/durable-sessions")}
        >
            Learn More
        </button>
    );
    ...
    return (
        <div className="flex flex-col gap-2 max-w-[280px]">
            ...
            <div className="text-xs text-secondary leading-relaxed">
                ...
                programs, and history alive through network changes, computer sleep, and Crowe Terminal restarts.
            </div>
            <button
...
function DurableDetachedContent({ onClose }: DurableDetachedContentProps) {
    return (
        <div className="flex flex-col gap-2 max-w-[280px]">
            ...
            <div className="text-xs text-secondary leading-relaxed">
                Connection lost, but your session is still running on the remote server. Crowe Terminal will
                automatically reconnect when the connection is restored.
            </div>
            <LearnMoreButton />
        </div>
    );
