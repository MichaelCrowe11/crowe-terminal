...
function createMockFilesystemEntries(): MockFsEntryInput[] {
    const entries: MockFsEntryInput[] = [
        ...
        { path: `${MockHomePath}/hypheus`, isdir: true },
        { path: `${MockHomePath}/hypheus/docs`, isdir: true },
        { path: `${MockHomePath}/hypheus/images`, isdir: true },
        ...
        makeMockFsInput(`${MockHomePath}/Downloads/hypheus-nightly.dmg`),
        ...
        makeMockFsInput(
            `${MockHomePath}/hypheus/README.md`,
            `# Mock WaveTerm Repo\n\nThis fake repo exists only in the preview environment.\nIt gives file previews something realistic to browse.\n`,
            "text/markdown"
        ),
        makeMockFsInput(`${MockHomePath}/hypheus/package.json`),
        makeMockFsInput(`${MockHomePath}/hypheus/tsconfig.json`),
        makeMockFsInput(`${MockHomePath}/hypheus/Taskfile.yml`),
        makeMockFsInput(`${MockHomePath}/hypheus/preview-model.tsx`),
        makeMockFsInput(`${MockHomePath}/hypheus/mockwaveenv.ts`),
        makeMockFsInput(`${MockHomePath}/hypheus/vite.config.ts`),
        makeMockFsInput(`${MockHomePath}/hypheus/CHANGELOG.md`),
        makeMockFsInput(
            `${MockHomePath}/hypheus/docs/preview-notes.md`,
        ...
        makeMockFsInput(`${MockHomePath}/hypheus/docs/filesystem-rpc.md`),
        makeMockFsInput(`${MockHomePath}/hypheus/docs/test-plan.md`),
        makeMockFsInput(`${MockHomePath}/hypheus/docs/connections.md`),
        makeMockFsInput(`${MockHomePath}/hypheus/docs/preview-gallery.md`),
        makeMockFsInput(`${MockHomePath}/hypheus/docs/release-notes.md`),
        makeMockFsInput(`${MockHomePath}/hypheus/images/hypheus-mark.png`, TinyPngBytes, "image/png"),
        makeMockFsInput(`${MockHomePath}/hypheus/images/hero.png`),
        makeMockFsInput(`${MockHomePath}/hypheus/images/avatar.jpg`),
        makeMockFsInput(`${MockHomePath}/hypheus/images/icon-16.png`),
        makeMockFsInput(`${MockHomePath}/hypheus/images/icon-32.png`),
        makeMockFsInput(`${MockHomePath}/hypheus/images/splash.jpg`),
        makeMockFsInput(
            `${MockHomePath}/.config/settings.json`,
            JSON.stringify(
                {
                    "app:theme": "crowe-logic-dark",
